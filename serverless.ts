...
const serverlessConfiguration: AWS = {
  ...
  functions: { savestudent, singleStudent, deleteStudent, updateStudent, createnewcourse, getonecourse, deleteonecourse, updateonecourse, createnewenrollment, getoneenrollment, deleteoneenrollment, updateoneenrollment, getenrollmentlist, getcourseslist, getstudentlist },
};
